...
public final class HeaderBinding implements ViewBinding {
  ...
  @NonNull
  public final TextView headerUser;

  private HeaderBinding(@NonNull LinearLayout rootView, @NonNull TextView headerUser) {
  ...
  public static HeaderBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.header_user;
      TextView headerUser = ViewBindings.findChildViewById(rootView, id);
      if (headerUser == null) {
        break missingId;
      }

      return new HeaderBinding((LinearLayout) rootView, headerUser);
    }
